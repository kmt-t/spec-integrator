...
def test_wit_verifier_valid_and_invalid(tmp_path):
    ...
    doc_file.write_text("""# WIT Specs {VERIFY_WIT}
## Overview
...
""", encoding="utf-8")
    ...
    wit_dir.mkdir()
    (wit_dir / "fireball.wit").write_text("""package fireball:host@0.1.0;
...
""", encoding="utf-8")
    ...
    (wit_dir / "invalid.wit").write_text("""package fireball:bad;
interface broken {
    func test() -> u32;
